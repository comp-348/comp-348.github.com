...
*** Other
At the end of the day, any text editor will work for writing your Lisp code. Notepad++, Vim,
Sublime, etc. If you use any of these other editors though, I'd highly recommend taking some time to
figure out what the best plugins for working with Lisp are because it will really be helpful.
