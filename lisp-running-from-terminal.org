...
There are a couple different ways that you can do it, and it depends on what compiler you're using.
Refer to the section for your compiler.
...
CCL has one argument for using it at the terminal that you'll care about, which is the ~--load~
